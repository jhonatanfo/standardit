...
<div class="card-body" style="padding-top:  0;">
    <div class="wrapper row">
        <div class="col-12 col-md-4">
            ...
            <div class="box">
                <div class="js--image-preview" <?php if($imagem != ""){ ?> style="background-image: url('../uploads/paginas/<?php  echo $imagem; ?>');" <?php } ?>></div>
                <div class="upload-options">
                    <label>
                        <input type="file" class="image-upload"  name="files[]" id="files1-<?php echo $sku; ?>" accept="image/*" value="uploads/paginas/<?php echo $imagem; ?>" />
                    </label>
                </div>
            </div>
        </div>
