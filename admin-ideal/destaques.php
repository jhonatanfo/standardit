...
include_once("destaques-config.php");
?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <title>Idealiz | Painel Administrativo | Destaques</title>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Destaques</h3>
              <a href="destaques-editor.php"><button type="button" class="btn btn-primary btn-novo"  data-toggle="tooltip" data-placement="left" title="Cadastrar novo destaque">Novo</button></a>
            </div>
            <!-- Light table -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
				...
				<?php
					$sql = "SELECT ideal_destaques.id_destaque, ideal_destaques.status, ideal_destaques_idioma.titulo, ideal_destaques_idioma.imagem
                            FROM ideal_destaques 
                            LEFT JOIN ideal_destaques_idioma ON ideal_destaques_idioma.id_destaque = ideal_destaques.id_destaque WHERE ideal_destaques_idioma.idioma = 'pt' order by ordem"; 
                  ...
                  <tr class="item_banner" id="<?php echo $id; ?>">
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3" style="background: #666 url(../uploads/destaques/<?php echo $imgconteudo; ?>) no-repeat center / cover; "></a>
                    ...
                    <td class="text-right">
                        <a href="destaques-editor?id=<?php echo $id; ?>"><button type="button" class="btn btn-outline-info ico"  data-toggle="tooltip" data-placement="left" title="Editar destaque"><i class="ni ni-settings-gear-65"></i></button></a>
                    </td>
                  </tr>
...
<script>
	...
	function salvarPermisao(a,b) {
	 ...
	 $.ajax({
	  url:'modulos/destaques/atualizar.php',
	  type:'POST',
	   data: {
		idbanner: a,
		posicao: b
