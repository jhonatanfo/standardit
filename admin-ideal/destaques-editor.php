			...
			<form id="form">
                <div class="card-header bg-transparent">
                  <div class="row align-items-center">
                    <div class="col">
                      <h3 class="mb-0">Cadastro de Destaques</h3>
                      <label class="custom-toggle checked-status">
                            <input type="checkbox" name="status" <?php if($statusdestaques == 1){ echo "checked";} else if($statusdestaques == 0){ echo "";} else{ echo "checked";} ?> >
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <?php 
                            ...
                            <div id="nav-<?php echo $sku; ?>" class="tab-pane fade <?php if($id_idioma == "1"){ echo "show active"; } ?>" role="tabpanel" aria-labelledby="nav-<?php echo $sku; ?>-tab">
                                ...
                                WHERE b.id_destaque = '".$id_destaque."' AND b.idioma = '".$sku."'"; 
                                ...
                                while($sqlidioma = mysqli_fetch_array($queryidioma)){ 
                                    ...
                                    $id_destaque = $sqlidioma["id_destaque"]; 
                                
                                    include "destaques-form.php"; ?> 
                                
                                
                                <?php  } } else { include "destaques-form.php";  }?> 
  ...
  function fireRipple(e){
   ...
   $( "input[name='nome']" ).on("input", function(){
    ...
    $('#submit').click(function(){
        ...
        $.ajax({
            url: 'modulos/destaques/ajaxfile.php',
            type: 'post',
            data: form_data,
            //dataType: 'json',
            contentType: false,
