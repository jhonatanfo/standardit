...
if(HOST == 'online'){
    ...
    define('DB_NAME', 'standardit');
    define('DB_USER', 'standardit');
    define('DB_PASSWORD', 'Ucf073_r');
    define('DB_HOST', 'standardit.mysql.dbaas.com.br');
    define('HOME_URL',$url);
    define("HOME_PATH",$url);
    define("HOME_AJAX",HOME_URL.'modulos/clientes/');
}
 
/*** TB DEFINE ***/
define('TB_IMG','ideal_clientes');
