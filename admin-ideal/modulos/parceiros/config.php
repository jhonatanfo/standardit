...
if(HOST == 'online'){
    ...
    define('DB_NAME', 'idealiz');
    define('DB_USER', 'idealiz');
    define('DB_PASSWORD', 'B7yF3awe.D4Y5c');
    define('DB_HOST', 'idealiz.mysql.dbaas.com.br');
    define('HOME_URL',$url);
    define("HOME_PATH",$url);
    define("HOME_AJAX",HOME_URL.'modulos/parceiros/');
}
 
/*** TB DEFINE ***/
define('TB_IMG','ideal_parceiros');
